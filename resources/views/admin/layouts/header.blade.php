    ...
    <div class="header-actions">
        <div class="dropdown">
            <button class="header-icon" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                @if ($soluongThongBaoChuaDoc > 0)
                    <span class="dot"></span>
                    <span class="header-count">{{ $soluongThongBaoChuaDoc > 99 ? '99+' : $soluongThongBaoChuaDoc }}</span>
                @endif
            </button>

            <div class="dropdown-menu dropdown-menu-end thongbao-dropdown">
                <div class="thongbao-dropdown-head">
                    <div>
                        <div class="fw-bold">Thông báo</div>
                        <div class="text-muted small">{{ $soluongThongBaoChuaDoc }} chưa đọc</div>
                    </div>
