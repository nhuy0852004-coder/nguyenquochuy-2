        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            window.Echo.channel('admin-thongbao')
                .listen('.donhang-moi', function (event) {
                    capNhatChuôngThongBao(event.thong_bao);
                    hienThiToastRealtime(event.thong_bao);
                    themThongBaoVaoDropdown(event.thong_bao);
                });

            function capNhatChuôngThongBao(thongBao) {
                ...
                if (nutChuong) {
                    ...
                    setTimeout(() => nutChuong.classList.remove('chuong-rung'), 600);
                }
            }
            ...
            function themThongBaoVaoDropdown(thongBao) {
                ...
                form.method = 'POST';
                form.action = thongBao.duong_dan || '#';
